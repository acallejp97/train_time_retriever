...
class TestNotificationService:
    @patch("app.notification_service.Apprise")
    ...
    @patch("app.notification_service.get_datetime")
    @patch("app.notification_service.Apprise")
    @patch.dict(os.environ, {"NOTIFICATION_URL": "tg://bottoken/chatid"})
    ...
    def test_send_message_calls_notify(self, mock_apprise_class):
        ...
        with patch("app.notification_service.get_datetime") as mock_get_datetime:
